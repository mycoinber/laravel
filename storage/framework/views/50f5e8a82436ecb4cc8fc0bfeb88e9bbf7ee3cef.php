...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="value[store_tax]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['store_tax'])) ? $itemValue['store_tax'] : old('store_tax')); ?>" class="form-control text-center  <?php $__errorArgs = ['store_tax'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/as453212/ed-libary.online/www/resources/views/admin/store/settings.blade.php ENDPATH**/ ?>