                        ...
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_referrals_export')): ?>
                                <div class="text-right">
                                    <a href="/admin/referrals/excel?type=users" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    <?php $__currentLoopData = $affiliates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiliate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(addCurrencyToPrice($affiliate->getTotalAffiliateRegistrationAmounts())); ?></td>

                                            <td><?php echo e(addCurrencyToPrice($affiliate->getTotalAffiliateCommissions())); ?></td>

                                            <td><?php echo e($affiliate->affiliateUser->affiliate ? trans('admin/main.yes') : trans('admin/main.no')); ?></td>

                                            <td>
                                                <a href="/admin/users/<?php echo e($affiliate->affiliateUser->id); ?>/edit" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/as453212/ed-libary.online/www/resources/views/admin/referrals/users.blade.php ENDPATH**/ ?>