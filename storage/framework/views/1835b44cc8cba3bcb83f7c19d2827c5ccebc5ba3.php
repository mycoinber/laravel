                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                <?php echo e(addCurrencyToPrice(round($allAffiliateAmounts, 2))); ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                <?php echo e(addCurrencyToPrice(round($allAffiliateCommissionAmounts, 2))); ?>
                        ...
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_referrals_export')): ?>
                                <div class="text-right">
                                    <a href="/admin/referrals/excel?type=history" class="btn btn-primary"><?php echo e(trans('admin/main.export_xls')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    <?php $__currentLoopData = $affiliates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiliate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(addCurrencyToPrice($affiliate->getReferredAmount())); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/as453212/ed-libary.online/www/resources/views/admin/referrals/history.blade.php ENDPATH**/ ?>